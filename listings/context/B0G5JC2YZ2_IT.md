# Context pack - B0G5JC2YZ2 / IT

SKU: `FR-4DCI-RB8W` - product type: `ANIMAL_PERCH`

## Copy attuale

**Titolo** (max 200) - 148 car.

> Amaca Gatti e Tiragraffi 2 in 1 in MDF e Sisal Naturale – Divano e Lettino per Gatti Sospeso, Robusto e Antigraffio – 54x44x28 cm - Montaggio Facile


**Bullet** (max 700)

1. (286 car.) 🐾 TIRAGRAFFI E AMACA 2 IN 1 — SALVA IL TUO DIVANO: il tuo gatto graffia dove deve, non sui mobili. Il tappetino in sisal naturale soddisfa l'istinto felino di farsi le unghie, mentre l'amaca sospesa gli regala uno spazio tutto suo dove riposare. Addio divano rovinato e tende strappate.
2. (379 car.) 🪵 MDF ROBUSTO, ZERO SPORCO IN CASA: realizzato in MDF di alta qualità, il telaio garantisce una buona resistenza alle deformazioni e una stabilità ottimale nel tempo. A differenza dei tiragraffi in cartone tradizionali, questa cuccia per gatti non si sfalda e non lascia residui sul pavimento. La struttura aperta tiene il baricentro basso per la massima sicurezza del tuo micio.
3. (445 car.) ☁️ AMACA SOSPESA IN SISAL — GRAFFIA E RIPOSA NELLO STESSO POSTO: il tappetino intrecciato in sisal naturale è teso su telaio in legno, così la superficie cede leggermente sotto il peso e avvolge il gatto a "culla" invece di lasciarlo su un piano rigido. Il sisal è una fibra vegetale traspirante che non trattiene il calore: comodo anche nelle giornate estive. Ed è l'unico letto che il tuo gatto può artigliare senza che tu debba dirgli niente.
4. (289 car.) 📏 54 x 44 x 28 CM — DIMENSIONI GENEROSE PER GATTI ADULTI: il tuo gatto può finalmente stendersi completamente e osservare la stanza dall'alto come piace a lui. La struttura aperta è adatta a gatti di taglia media e grande — uno spazio davvero su misura per il tuo compagno a quattro zampe.
5. (278 car.) 🛠️ MONTAGGIO IN POCHI MINUTI — CHIAVE E ISTRUZIONI INCLUSE: solo 5 pezzi, nessun attrezzo da comprare. Le istruzioni illustrate passo passo sono nella confezione. Il legno chiaro e le linee pulite si integrano con eleganza in qualsiasi arredamento — senza ingombrare il salotto.

**Descrizione** - 1344 car.

> Il letto che il tuo gatto può graffiare.

Il gatto non graffia il divano per dispetto: lo fa perché ha bisogno di allungare i muscoli e affilare le unghie su una superficie che oppone resistenza. L'Amaca 2 in 1 di Lupo & Felix gli dà quella superficie — e ci mette sopra un posto dove dormire.

SISAL NATURALE TESO SU TELAIO IN MDF in fibre di legno
Il tappetino intrecciato è montato in tensione su tre aste: cede quel tanto che basta per accogliere il gatto a culla, resta abbastanza rigido da resistere agli artigli. Fibra vegetale traspirante, che non trattiene il calore.

Medium Denisty Fiberboard, NON CARTONE
Niente residui sul pavimento, niente strati che si sfaldano dopo un mese. Il telaio resiste alle deformazioni e la geometria aperta tiene il baricentro basso. 

54 x 44 x 28 CM
Spazio per stendersi davvero, anche per gatti di taglia media e grande. L'altezza rialzata gli permette di tenere d'occhio la stanza — la posizione che i gatti scelgono sempre.

MONTAGGIO IN POCHI MINUTI
Cinque pezzi, chiave inclusa, istruzioni illustrate nella confezione. Legno chiaro e linee pulite: sta in salotto senza sembrare un accessorio per animali.

CURA: pulire con un panno umido. Non lavare in lavatrice. CUCCIA DA INTERNO non lasciare sotto le interperie

Lupo & Felix — selezionato e testato dai nostri gatti prima che arrivi dal tuo.
...
- Immagini (21):
    ...
    - PT02: https://m.media-amazon.com/images/I/517lL8ONapL.jpg
    - PT02: https://m.media-amazon.com/images/I/517lL8ONapL._SL75_.jpg
...
- **Forza** (2 menzioni)
    - “robusta il giusto, considerando il prezzo.”
    - “che viene definita "legno robusto",”
- **Durabilità** (1 menzioni, impatto stelle 2.52)
    - “Molto carina e resistente, è ben fatta ed è anche un bel complemento d' arredo in balcone, giardino o dove si voglia per far riposare il proprio gatto”
- **Design generale** (1 menzioni)
    - “è stato un successo anche se ho diversi appunti in relazione al prodotto.”
- **Dimensioni generali** (1 menzioni, impatto stelle 1.26)
    - “Le dimensioni sono generose”
- **Adatto agli animali domestici** (1 menzioni)
    - “è stato un successo anche se ho diversi appunti in relazione al prodotto.”
- **Montaggio/Installazione** (1 menzioni, impatto stelle 1.12)
    - “Il montaggio è semplice e veloce, anche grazie alla chiave inclusa in dotazione per stringere le viti”

**Cosa lamentano (negativi) - obiezioni da anticipare nella copy:**
- **Qualità del materiale** (1 menzioni, impatto stelle -0.7)
    - “La struttura non è in legno, sembra cartonato, se si bagna si gonfia”
- **Dimensioni generali** (1 menzioni)
    - “lassù...peccato non ci siano misure più grandi.”
- **Qualità in generale** (1 menzioni, impatto stelle -0.15)
    - “la qualità costruttiva non mi ha convinta del tutto”


## Termini che convertono (report search term Amazon Ads)

Termini di ricerca reali su cui **questo ASIN** (B0G5JC2YZ2) e' stato pubblicizzato su IT.
...
- tiragraffi per gatti — 12 click, 4.90 € spesi, 0 acquisti
...
- amaca gatti — 4 click, 1.01 € spesi, 0 acquisti
- amaca termosifone gatto — 3 click, 0.95 € spesi, 0 acquisti
- dondolo per gatti — 2 click, 0.88 € spesi, 0 acquisti
- b0frltbczc — 2 click, 0.86 € spesi, 0 acquisti
- cuccia gatto amaca — 2 click, 0.86 € spesi, 0 acquisti
...
- PawHut Brandina per Cani Pieghevole Taglia Piccola 59x46x15 cm Grigio Scuro — PawHut
- Amazon Basics per Cane Lettino rialzato rinfrescante per animali domestici, Stoffa, Grigio, Misura M, L 110 x P 65 x H 19 cm — Amazon Basics
